...
public class Kutuphane {
    ...
    public Kutuphane(int kitap_id, String kitap_adi, int sayfa_sayisi, int basim_tarihi, Yayinevi yayinevi_id) {
        this.kitap_id = kitap_id;
        this.kitap_adi = kitap_adi;
    ...
    public Yayinevi getYayinevi_id() {
        return yayinevi_id;
    }

    public void setYayinevi_id(Yayinevi yayinevi_id) {
        this.yayinevi_id = yayinevi_id;
    }
    ...
    public void idArama(int kitap_id) throws SQLException{
      ...
      String sql = "SELECT * FROM kutuphane where kitap_id='" + kitap_id + "'";
      
      try {
            Statement sta = bag.c.createStatement();
            sta.execute(sql);
            JOptionPane.showMessageDialog(null, "Aradiginiz Sonuc:  ");
        } catch (Exception e) {
            
            JOptionPane.showMessageDialog(null, "Sonuc Bulunamadi");
